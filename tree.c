...
/*int main(void)
{
    ...
    add(&head,"77","Larry","Jones","A","E","11-02-1993","-");
    add(&head,"125","Larry","Jones","B","D","10-02-2019","-");
    add(&head,"0","Larry","Jones","C","C","1-02-2009","-");
    add(&head,"15","Larry","Jones","A","D","5-02-2010","-");
    add(&head,"776","Larry","Jones","B","E","11-02-2003","-");
    ...
    //printf("count in range %d\n", count_in_range(root,"11-02-2011","11-02-2020"));
    //printf("disease count in range %d\n", disease_count_in_range(root,"SARS-1" ,"11-02-2000","11-02-2020"));
    //node* a = search_recordID(root,"77");
    print_tree(root,0);
    printf("%s\n", "*******");
    //print_record(a->record);
    //printf("stILL %d\n", stILL(root));
    topk_dates(root,1,5,"1-1-1995","20-2-2000");
    topk_dates(root,0,5,"1-1-1998","20-2-2005");
    //printf("%s\n",get_entryDate(root->record));
